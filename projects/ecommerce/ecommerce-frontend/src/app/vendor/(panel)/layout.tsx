...
export default function VendorPanelLayout({
  ...
  const { isAuthenticated, isVendor, isAdmin, username, logout } = useAuthStore();
  ...
  }, [hydrated, isAuthenticated, isVendor, isAdmin, router]);

  // Show nothing until Zustand has rehydrated — prevents flash redirect
  if (!hydrated) return null;

  // After hydration, guard the render
        ...
        <div className="p-4 border-b">
          <Link href="/vendor" className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="text-sm font-semibold leading-none truncate">Vendor Panel</p>
